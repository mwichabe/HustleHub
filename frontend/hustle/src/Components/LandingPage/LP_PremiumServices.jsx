        ...
        >
            <Box>
                ...
                <Flex justifyContent="flex-end">
                    <Button as={Link} to="/payment" variant="ghost" leftIcon={<ArrowForwardIcon />}> INITIALISE PAYMENT </Button>
                </Flex>            
            </Box>
            <Box>
                <Img src="https://img.freepik.com/free-vector/status-update-concept-illustration_114360-1567.jpg?w=1380&t=st=1661502647~exp=1661503247~hmac=478c444e6621d96e926013b603e91f78e6a67b34e3e34d07e81b61529a34f766"/>
                    <Text>Interview Preparation</Text>
                    <Text>Get confidence to answer interview questions, depending on your area of specialisation </Text>
                    <Flex justifyContent="flex-end">
                    <Button as={Link} to="/payment" variant="ghost" leftIcon={<ArrowForwardIcon />}> INITIALISE PAYMENT </Button>
                </Flex>            
            </Box>
            <Box>
                ...
                <Text>Employer Direct Connection</Text>
                <Text>Get direct connection with potential clients to grow your business</Text>
                <Flex justifyContent="flex-end">
                    <Button as={Link} to="/payment"  variant="ghost" leftIcon={<ArrowForwardIcon />}>INITIALISE PAYMENT </Button>
                </Flex>                
            </Box>
            <Box>
                ...
                <Text>Guidelines to Success</Text>
                <Text>Learn how to grow your business understanding the risks and how to solve them.</Text>
                <Flex justifyContent="flex-end">
                    <Button as={Link} to="/payment" variant="ghost" leftIcon={<ArrowForwardIcon />}> INITIALISE PAYMENT</Button>
                </Flex>
            </Box>
